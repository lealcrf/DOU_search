        ...
        return self.query(
            self.contains(
                ...
                [
                    ...
                    Pattern("cargo de Presidente do Banco Central", ""),  # A6
                    Pattern("cargo de Diretor do Banco Central", ""),  # A7
                    Pattern("cargo de Diretora do Banco Central", ""),  # A7
                    Pattern("cargo de Ministro de Estado da Economia", ""),  # A10
                    Pattern(
                    ...
                    Pattern("cargo de Secretário de Política Econômica", ""),  # A13
                    Pattern("cargo de Secretário do Tesouro Nacional", ""),  # A14
                    Pattern(
